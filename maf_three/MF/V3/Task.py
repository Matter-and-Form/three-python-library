from MF.V3.Descriptors.Progress import Progress as MF_V3_Descriptors_Progress_Progress
...
class Task:
    """*
     ...
     ```
    """
    def __init__(self, Index: int, Type: str, Input: _any_pb2 = None, Output: _any_pb2 = None, State: 'TaskState' = None, Error: str = None, Progress: MF_V3_Descriptors_Progress_Progress = None):
