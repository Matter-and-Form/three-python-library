...
class RemoveProjects:
    ...
    class Request:
        ...
        def __init__(self, Index: int, Type: str, Input: List[int]):
    ...
    class Response:
        ...
        def __init__(self, Index: int, Type: str, Input: List[int], Output: MF_V3_Descriptors_Project_Project.Brief = None, State: MF_V3_Task_TaskState = None, Error: str = None):
