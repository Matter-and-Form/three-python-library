...
class Scanner:
    ...
    def set_projector(self, on: bool = None, brightness: float = None, pattern: MF.V3.Settings.Projector.Projector.Pattern = None, image: MF.V3.Settings.Projector.Projector.Image = None, color: List[float] = None) -> MF.V3.Task.Task: ...
    ...
    def system_info(self, installed: List[MF.V3.Settings.Software.Software.Package] = None, available: List[MF.V3.Settings.Software.Software.Package] = None, nightlyIncluded: bool = None) -> MF.V3.Task.Task: ...
