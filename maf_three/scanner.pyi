...
import maf_three
import maf_three.MF
import maf_three.MF.V3
import maf_three.MF.V3.Buffer
import maf_three.MF.V3.Three
import maf_three.serialization
import threading
import time
import types
import typing
...
class Scanner:
    ...
    def auto_focus(self, cameras: MF.V3.Settings.AutoFocus.AutoFocus.Camera, applyAll: bool) -> MF.V3.Task.Task: ...
    ...
    def export(self, selection: MF.V3.Settings.ScanSelection.ScanSelection = None, texture: bool = None, merge: bool = None, format: MF.V3.Settings.Export.Export.Format = None) -> MF.V3.Task.Task: ...
    def export_logs(self, Input: bool = None) -> MF.V3.Task.Task: ...
    def export_merge(self, selection: MF.V3.Settings.ScanSelection.ScanSelection = None, texture: bool = None, merge: bool = None, format: MF.V3.Settings.Export.Export.Format = None) -> MF.V3.Task.Task: ...
    ...
    def merge_data(self, index: int, buffers: MF.V3.Settings.ScanData.ScanData.Buffer, metadata: MF.V3.Settings.ScanData.ScanData.Metadata, mergeStep: MF.V3.Settings.ScanData.ScanData.MergeStep = None) -> MF.V3.Task.Task: ...
    def move_group(self, Input: int) -> MF.V3.Task.Task: ...
    def new_group(self, color: float, rotation: float, translation: float, parentIndex: int = None, baseName: str = None, visible: bool = None, collapsed: bool = None) -> MF.V3.Task.Task: ...
    ...
    def remove_groups(self, Input: int) -> MF.V3.Task.Task: ...
    def remove_projects(self, Input: int) -> MF.V3.Task.Task: ...
    def restore_factory_calibration(self) -> MF.V3.Task.Task: ...
    def rotate_turntable(self, Input: int) -> MF.V3.Task.Task: ...
    def scan_data(self, index: int, buffers: MF.V3.Settings.ScanData.ScanData.Buffer, metadata: MF.V3.Settings.ScanData.ScanData.Metadata, mergeStep: MF.V3.Settings.ScanData.ScanData.MergeStep = None) -> MF.V3.Task.Task: ...
    def set_cameras(self, selection: int, autoExposure: bool = None, exposure: int = None, analogGain: float = None, digitalGain: int = None, focus: int = None) -> MF.V3.Task.Task: ...
    def set_group(self, index: int, color: float, rotation: float, translation: float, name: str = None, visible: bool = None, collapsed: bool = None) -> MF.V3.Task.Task: ...
    def set_project(self, index: int = None, name: str = None) -> MF.V3.Task.Task: ...
    def set_projector(self, color: float, on: bool = None, brightness: float = None, pattern: MF.V3.Settings.Projector.Projector.Pattern = None, image: MF.V3.Settings.Projector.Projector.Image = None) -> MF.V3.Task.Task: ...
    ...
    def system_info(self, installed: MF.V3.Settings.Software.Software.Package, available: MF.V3.Settings.Software.Software.Package, nightlyIncluded: bool = None) -> MF.V3.Task.Task: ...
    def transform_group(self, index: int, color: float, rotation: float, translation: float, name: str = None, visible: bool = None, collapsed: bool = None) -> MF.V3.Task.Task: ...
    ...
    def upload_project(self) -> MF.V3.Task.Task: ...